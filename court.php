                ...
                <div class="row g-0 p-3 align-items-center">
                    ...
                    <div class="col-md-2">
                        <div class="card-body align-text-center">
                            <button type="button" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2" data-bs-toggle="modal" data-bs-target="#booking">
                                Book
                            </button>
                    ...
                    <div class="modal fade" id="booking" data-bs-backdrop="static" tabindex="-1" aria-labelledby="general-s" aria-hidden="true">
                        <div class="modal-dialog ">
                            <form id="badminton_form"> 
                                <div class="modal-content">                       
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="general-s">Badminton Court</h5>
                                        ...
                                        <div class="container-fluid p-0">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="modal-body">
                                                        <div class="mb-3 ">
                                                            <label class="form-label fw-bold">Book From</label>
                                                            <input type="date" name="book_from" class="form-control shadow-none" id="book_from_inp" required>
                                                        </div>
                                                        <div class="mb-3 ">
                                                            <label class="form-label fw-bold">Book To</label>
                                                            <input type="date" name="book_to" class="form-control shadow-none" id="book_to_inp"  required>
                                                        </div>
...
<h6 class="text-center bg-dark text-white p-3">Designed and Developed by Parv,Raj and Rupam </h6>
...
<script>
    let badminton_form = document.getElementById("badminton_form");

    badminton_form.addEventListener("submit", function(e){
        e.preventDefault();
        update_badminton_court();
    })

    function update_badminton_court(){
        
        let badminton = ['book_from','book_to'];
        let badminton_inp = ['book_from_inp','book_to_inp'];

        let data_arg = "";

        for(i=0;i<badminton.length;i++){
            data_arg +=badminton[i] + "=" + document.getElementById(badminton_inp[i]).value + "&";
        }
        data_arg += "name=badminton&update_badminton_court"; 
        console.log(data_arg);
        let xhr = new XMLHttpRequest();
        xhr.open("POST","admin/ajax/courts_ad.php",true);
        xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
        xhr.onload = function(){
            var myModal = document.getElementById("booking");
