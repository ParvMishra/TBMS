...
<?php
    ...
    if($setting_r['shutdown']){
        ...
        $book_btn="<a href='#' class='btn btn-sm text-white custom-bg shadow-none'>Book</a>";
    }
?>
                    ...
                    <div class="card border-0 shadow" style=" max-width: 350px;margin:auto;">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-evenly">
                            <button class='btn btn-sm text-white custom-bg shadow-none'>Book</button>
...
<h6 class="text-center bg-dark text-white p-3">Designed and Developed by Parv And Raj and Rupam</h6>
